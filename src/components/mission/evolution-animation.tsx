...
const EvolutionAnimation = () => {
  return (
    <div className="grid grow grid-cols-8 grid-rows-1 gap-2">
      <div className="relative z-10 col-span-full row-start-1 aspect-video">
      ...
      <div className="relative z-30 col-span-2 col-start-1 row-start-1 flex items-end justify-center pb-4">
        <Ape className="translate-y-[6px] scale-[.6] md:scale-[.8] lg:-translate-y-[13px] xl:-translate-y-[32px]" />
      </div>
      <div className="relative z-30 col-span-2 col-start-3 row-start-1 flex items-end justify-center pb-4">
        <Ape className="translate-y-[4px] scale-[.65] md:scale-[.9] lg:-translate-y-[16px] xl:-translate-y-[36px]" />
      </div>
      <div className="relative z-30 col-span-2 col-start-5 row-start-1 flex items-end justify-center pb-4">
        <Ape className="scale-[.7] md:scale-100 lg:-translate-y-[20px] xl:-translate-y-[40px]" />
      </div>
      <div className="relative z-30 col-span-2 col-start-7 row-start-1 flex items-end justify-center pb-4">
        <Oermens className="translate-y-[15px] scale-[.7] md:scale-100 lg:-translate-y-[11px] xl:-translate-y-[28px]" />
      </div>
    </div>
  );
};
