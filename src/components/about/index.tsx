...
const About = () => {
  ...
  <Container className={"my-12"}>
    <RevealWrapper Element={'div'} className="col-span-5 col-start-2 md:col-span-5 xl:col-span-4 xl:row-start-1 xl:row-span-3 flex flex-col gap-4" delay={0}>
        <h2 className="flex flex-col">
          ...
          <RevealWrapper Element={"p"} delay={.3} className="-translate-y-[2px]">Front-end developer</RevealWrapper>
        </h2>
        <div>
    ...
    <RevealWrapper Element={"div"} delay={.125} className="col-span-5 col-start-1 max-sm:row-start-6 md:col-span-7 md:col-start-6 md:row-start-1 xl:col-span-3 xl:col-start-5 xl:row-start-1 xl:row-span-2">
    ...
    <RevealWrapper Element={"div"} delay={.25} className="max-sm:row-start-7 col-span-5 col-start-2 lg:mt-2 lg:col-start-1 xl:mt-0 lg:col-span-5 xl:col-span-3 xl:row-start-3 xl:row-span-2 xl:col-start-5">
    ...
    <div className="max-sm:row-start-8 col-start-1 col-span-6 lg:col-span-5 xl:col-span-4 lg:col-start-1 flex flex-col">
      ...
      {tools.map((toolRow, i) => (
        <div key={i} className={`-translate-y-${i * 2} flex gap-2`}>
          {toolRow.map((tool, j) => (
            <RevealWrapper className="rounded-lg pt-1 font-grotesk text-xl font-bold text-white" Element={"p"} delay={j * i/6  * 0.2}
            key={j}
            >
              {tool}
            </RevealWrapper>
